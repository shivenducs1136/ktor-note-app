...
class AuthViewModel @ViewModelInject constructor(
    ...
    private val _registerStatus: MutableLiveData<Resource<String>> = MutableLiveData<Resource<String>>()
    val registerStatus:LiveData<Resource<String>> = _registerStatus

    private val _loginStatus: MutableLiveData<Resource<String>> = MutableLiveData<Resource<String>>()
